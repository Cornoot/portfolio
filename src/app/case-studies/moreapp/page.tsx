...
const MoreAppCaseStudy = () => (
  <main>
    ...
    <div className="mx-auto max-w-[856px] pt-18">
      ...
      <div className="flex max-w-[768px] flex-col gap-y-5">
        ...
        <div className="space-y-1">
          ...
          <Text>
            Document everything you do. When I worked alone at the start at MoreApp I quickly wanted to scale up the way
            I was working. So I wrote down everything I did. Added padding to new elements in a design system? Wrote it
