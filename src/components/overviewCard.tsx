...
const CaseStudyOverviewCard = ({ title, subtitle, image, meta }: OverviewCardProps) => {
  const classes = clsx("flex w-full flex-col gap-y-6 rounded-3xl bg-gray-800", image ? " px-10 pb-10 pt-6" : "p-10");
  return (
...
export default CaseStudyOverviewCard;
